...
2. Looping through the list of dictionaries held in the MongoDB was a challenge.  I understand that my code could be refactored to include these loops, but considering there are only 4 items I have manually accessed each dictionary by the index list and key.  
3. Creating the clickable thumbnails was a bit of a challenge.  Finally, it occured to me that I could look at how the source url would have an exmaple that I could use for guidance on the syntax.  My app still lacks home buttons on the landing pages of the image thumbnails.  I imagine that I would need to create index html pages for each of the 4 images.
